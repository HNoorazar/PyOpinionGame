...
import config as og_cfg
import IO as og_io
import coupling as og_coupling
import state as og_state
import adjacency as og_adj
import selection as og_select
import potentials as og_pot
import core as og_core
import stopping as og_stop
...
uppBound_list = np.arange(0.018, 0.022, 0.002)
...
noGames = np.arange(10)    # Number of different game orders.
